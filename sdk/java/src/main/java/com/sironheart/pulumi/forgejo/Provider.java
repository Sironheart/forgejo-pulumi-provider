...
import com.sironheart.pulumi.forgejo.ProviderArgs;
import com.sironheart.pulumi.forgejo.Utilities;
import java.lang.String;
import java.util.List;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:forgejo")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("forgejo", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
