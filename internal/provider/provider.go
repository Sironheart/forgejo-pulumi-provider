...
func Provider() p.Provider {
	return infer.Provider(infer.Options{
		Resources: []infer.InferredResource{
			...
			infer.Resource(OrganizationTeamMember{}),
			...
			infer.Resource(RepositoryActionSecret{}),
			infer.Resource(OrganizationActionSecret{}),
			infer.Resource(OrganizationActionVariable{}),
			infer.Resource(RepositoryBranchProtection{}),
			infer.Resource(RepositorySettings{}),
		},
